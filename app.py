...
if menu == "Klasifikasi Tumor": 
    ...
    if uploaded is not None:    
        ...
        container = st.container(width=300)
        container.image(image, caption='Gambar yang diunggah', width='stretch')
    ...
    if pilihan == "Glioma":
        st.subheader("Glioma")
        container = st.container(width=260)
        container.image("glioma.jpg", width="stretch")
        ...
        container = st.container(width=260)
        container.image("meningioma.jpg", width="stretch")
        ...
        st.subheader("Normal")
        container = st.container(width=260)
        container.image("normal.jpg", width="stretch")
        ...
        container = st.container(width=260)
        container.image("pituitari.jpg", width="stretch")
